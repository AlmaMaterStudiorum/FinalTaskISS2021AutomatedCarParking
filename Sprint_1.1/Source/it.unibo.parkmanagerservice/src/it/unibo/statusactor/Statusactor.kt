		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="carrequest_int_state",cond=whenRequest("carrequest_int"))
					transition(edgeName="t07",targetState="carenter_int_state",cond=whenRequest("carenter_int"))
					transition(edgeName="t08",targetState="pickup_int_state",cond=whenRequest("pickup_int"))
					transition(edgeName="t09",targetState="start_state",cond=whenDispatch("start"))
					transition(edgeName="t010",targetState="stop_state",cond=whenDispatch("stop"))
					transition(edgeName="t011",targetState="simready_state",cond=whenDispatch("simready"))
					transition(edgeName="t012",targetState="move_state",cond=whenDispatch("move"))
				}	 
